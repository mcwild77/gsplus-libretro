/*
 * gsplus-font.i -- 8x8 bitmap font for the on-screen keyboard.
 *
 * Ported from vice-libretro (libretro/libretro-font.i, GPLv2-or-later, the
 * "Commodore font set"). GSplus modifications: the two Amiga-key icon slots
 * (font codes 13 and 14, unused on the Apple IIgs) are redefined as the IIgs
 * Open-Apple (outline) and Solid-Apple (filled) key glyphs. These two glyphs
 * are functional placeholders -- see claudedocs/osk-glyph-art.md for the art
 * request. Original VICE copyright retained by its authors.
 */
...
0x08, 0x18, 0x6C, 0xC3, 0x81, 0x81, 0x81, 0x66, /* GSplus: open-apple (outline) 13 */
0x08, 0x18, 0x6C, 0xFF, 0xFF, 0xFF, 0xFF, 0x66, /* GSplus: solid-apple (filled) 14 */
0xA8, 0x00, 0xA8, 0x00, 0xA8, 0x00, 0xE8, 0x00, /* numpad 15 */
0x02, 0x02, 0x12, 0x32, 0x7E, 0x30, 0x10, 0x00, /* return 16 */
0x40, 0x60, 0x70, 0x78, 0x78, 0x70, 0x60, 0x40, /* reset: right-pointing triangle 17 */
...
0x00, 0x24, 0x6C, 0xFC, 0x6C, 0x24, 0x00, 0x00, /* datasette rwd 21 */
0x00, 0x48, 0x6C, 0x7E, 0x6C, 0x48, 0x00, 0x00, /* datasette fwd 22 */
