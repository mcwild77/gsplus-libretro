/*
 * libretro-graph.h -- software drawing primitives (rects, boxes, bitmap text
 * with alpha blending) for the on-screen keyboard.
 *
 * Ported from vice-libretro (https://github.com/libretro/vice-libretro),
 * libretro/libretro-graph.h, which is licensed GPLv2-or-later. GSplus is GPLv3;
 * the combined work is distributed under the GPL. Modifications for GSplus:
 *   - draw into the GSplus XRGB8888 framebuffer via libretro-glue.h instead of
 *     VICE's libretro-core.h.
 * Original VICE copyright is retained by its authors.
 */
...
/* Apple IIgs desktop blue accent (added for GSplus). */
#define COLOR_IIGS_16            RGB565(  0,  85, 170)
#define COLOR_IIGS_32      ARGB888(255,   0,  85, 170)
