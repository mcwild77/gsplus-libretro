/*
 * libretro-graph.c -- software drawing primitives for the on-screen keyboard.
 *
 * Ported from vice-libretro (https://github.com/libretro/vice-libretro),
 * libretro/libretro-graph.c, licensed GPLv2-or-later. GSplus is GPLv3; the
 * combined work is distributed under the GPL. Original VICE copyright is
 * retained by its authors.
 *
 * Modifications for GSplus: the VICE frontend header (libretro-core.h) is
 * replaced by the small libretro-glue.h shim, which supplies retro_bmp / retrow
 * / pix_bytes pointing at the GSplus XRGB8888 framebuffer. Otherwise verbatim.
 */
#include <stdio.h>
#include <stdlib.h>
#include <stdarg.h>
